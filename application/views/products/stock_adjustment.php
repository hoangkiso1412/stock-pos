                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            <label class="col-form-label"
                                   for="from_warehouse"><?php echo $this->lang->line('Warehouse') ?></label>
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control required"
                                       placeholder="Transfer Date" name="adjustdate"
                                    ...
                                    <td>
                                        ...
                                        <div class="form-group row">
                                            <input type="submit" id="submit-data" class="btn btn-success"
                                                   value="<?php echo $this->lang->line('Save Adjustment') ?>"
                                                   data-loading-text="Adding...">
                                            <input type="hidden" value="products/stock_adjustment" id="action-url">
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
