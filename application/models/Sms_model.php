...
class Sms_model extends CI_Model
{
    ...
    public function send_sms($mobile, $text_message)
    {
        /*
        ...
        switch ($gateway_code) {
            ...
            case 6:
                ...
                break;
            case 7:
                $this->nexmo($mobile, $text_message);
                break;
        }
    }
    ...
    {
        $country = 91;
        $sender_id = $this->config->item('msg91_api_key');
        $route = '4';
        $authkey = $this->config->item('msg91_sender_id');
