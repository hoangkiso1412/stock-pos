...
<div class="invoice-box">
            ...
            <td class="myw">
                <table class="top_sum">
                    ...
                    <tr>
                        ...
                        <td>DO#<?php echo str_pad($invoice['tid'], 8, '0', STR_PAD_LEFT) ?></td>
                    </tr>
                    <tr>
                        <td><?php echo $this->lang->line('Invoice') ?></td>
                        <td><?php echo $this->config->item('prefix') . str_pad($invoice['tid'], 8, '0', STR_PAD_LEFT) ?></td>
                    </tr>
                    <tr>
                        <td>DO Date</td>
        ...
        foreach ($products as $row) {
            ...
            if ($row['product_des']||$row['product_unique_id']) {
                ...
                echo '<tr class="item' . $flag . ' descr"> 
                            <td colspan="' . $cc . '">' . ($row['product_unique_id']? 'Key: '.$row['product_unique_id'].'<br>':'') . nl2br($row['product_des']) . '<br>&nbsp;</td>
    ...
    <table>
        <tr>
            <td>
                <center>
                    <div class="sign"><?php echo $this->lang->line('Authorized person')?></div>
                    <div class="sign1">
                        <?php
            ...
            <td>
            <center><br><br><br><div class="signr">_____________________________<br><?php echo $this->lang->line('Received by') ?></center>
            </td>
        </tr>
    </table>
    <?php
    echo $this->lang->line('Terms') . ':</strong><div class="terms">' . $invoice['notes'] . '';
