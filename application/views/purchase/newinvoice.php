                ...
                <form method="post" id="data_form">
                            ...
                            <div id="customerpanel" class="inner-cmp-pnl">
                                ...
                                <div id="customer">
                                    ...
                                    <hr><?php echo $this->lang->line('Warehouse') ?> <select id="s_warehouses"
                                                                                             class="selectpicker form-control" name="s_warehouse">
                                        <?php 
                    ...
                    <div id="saman-row">
                        <table class="table-responsive tfr my_stripe">
                            ...
                            <tbody>
                                <tr>
                                    <td><input type="text" class="form-control" name="product_name[]"
                                               ...
                                               id='productname_purchase-0' autocomplete="off">
                                    </td>
                                    <td><input type="text" class="form-control" name="product_unique_id[]"
                                               placeholder="<?php echo $this->lang->line('Unique ID') ?>"
                                               id='product_unique_id-0' data-role="purchase_unique_key" data-key="uniquekey" autocomplete="off">
                                    </td>
                                    <td>
                                    ...
                                    <td><input type="text" class="form-control req amnt" name="product_qty[]" id="amount-0"
                                               ...
                                               autocomplete="off" value="1" data-key="qty"></td>
                            ...
                            <input type="hidden" class="qtyIn" name="qtyIn[]" id="qtyIn-0">
                            </tr>
                            <tr>
