                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="title-action">
                            ...
                            <a href="#pop_model2" data-toggle="modal" data-remote="false"
                               class="btn btn-large btn-info mb-1 hidden" title="Convert to Invoice"
                            ><span class="fa fa-share"></span> <?php echo $this->lang->line('Convert to Invoice') ?>
                               ...
                               class="btn btn-large btn-blue-grey mb-1 hidden" title="Convert to Purchase"
                            ...
                            <span
                                ...
                                <div class="dropdown-menu"><a href="#sendSMS" data-toggle="modal"
                                                              ...
                                                              data-type="quote"><?php echo $this->lang->line('Send Proposal') ?> to Telegram</a>
                            ...
                            <div class="btn-group ">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item"
                                       href="<?= base_url('billing/printquote?no=1&id=' . $invoice['iid'] . '&token=' . $validtoken); ?>"><?php echo $this->lang->line('Print')." No Signature" ?></a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item"
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('Send'); ?> To Telegram</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
            <div id="request_sms">
                <div id="ballsWaveG1">
