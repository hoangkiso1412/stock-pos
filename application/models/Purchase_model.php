...
class Purchase_model extends CI_Model
{
    ...
    public function purchase_products_stock($id)
    {
        $this->db->select("p.*,ifnull(s.id,0) as stock_id,ifnull(s.qty,0) as stock_qty,ifnull(s.sale_status,'in-stock') sale_status,ifnull(s.init_stock,0) init_stock,s.product_desc stock_desc");
        $this->db->from('geopos_purchase_items p');
    ...
    public function get_purchase_warehouse_name($id=0){
