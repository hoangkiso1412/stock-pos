                                ...
                                <li class="col-md-3">
                                    ...
                                    <div id="accordionWrap3" role="tablist" aria-multiselectable="true">
                                        <div class="card border-0 box-shadow-0 collapse-icon accordion-icon-rotate">
                                            ...
                                            <div class="card-header p-0 pb-1 border-0 mt-1 hidden" id="heading12" role="tab">
                                                <a class=" text-uppercase black" data-toggle="collapse"
                                                   data-parent="#accordionWrap3" href="#accordion12"
                                                   aria-controls="accordion12"><i
                                                            class="fa fa-print"></i>POS Printers</a>
                                                </a></div>
                                            <div class="card-collapse collapse mb-1 hidden" id="accordion12" role="tabpanel"
    ...
    <div class="main-menu-content">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item has-sub <?php if ($this->li_a == "stock") {
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="menu-item"><a class="dropdown-item"
                                                 href="<?php echo base_url(); ?>products/stock_transfer_list"><i
                                        class="ft-wind"></i><?php echo $this->lang->line('Stock Transfer'); ?></a>
                        </li>
                        <li class="menu-item"><a class="dropdown-item"
                                                 href="<?php echo base_url(); ?>products/stock_adjustment_list"><i
                                        class="icon-puzzle"><?php echo $this->lang->line('Stock Adjustment'); ?></a>
                        </li>
                        </li>
                        ...
                        <li class="menu-item hidden"><a href="#"><i
            ...
            if ($this->aauth->premission(5)) {
                ...
                <li class="hidden menu-item  has-sub <?php if ($this->li_a == "promo") {
                    echo ' open';
                } ?>"><a href="#"><i
            ...
            if ($this->aauth->get_user()->roleid > 4) {
                ...
                <li class="menu-item   has-sub <?php if ($this->li_a == "export") {
                    ...
                    <span><?php echo $this->lang->line('Backup & Export') . '-' . $this->lang->line('Import'); ?></span></a>
                <ul class="menu-content">
                    ...
                    <li class="hidden"><a href="<?php echo base_url(); ?>import/products"><i
                                    class="fa fa-caret-right"></i> <?php echo $this->lang->line('Import Products'); ?>
                        </a></li>
