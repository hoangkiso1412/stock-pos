            ...
            <div id="invoice-template" class="card-body">
                        ...
                        if ($invoice['status'] != 'canceled') { ?>
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-blue dropdown-toggle mb-1"
                                        ...
                                        aria-haspopup="true" aria-expanded="false">
                            <span
                                    class="fa fa-mobile"></span> Send to Telegram
                                </button>
                            ...
                            <div class="btn-group ">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item"
                                       href="<?= base_url('billing/printinvoice?no=1&id=' . $invoice['iid'] . '&token=' . $validtoken); ?>"><?php echo $this->lang->line('Print')." No Signature" ?></a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item"
                            ...
                            <div class="btn-group ">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item"
                                       href="<?= base_url() . 'invoices/delivery?no=1&id=' . $invoice['iid']; ?>"><?php echo $this->lang->line('Delivery Note'). " No Sign" ?></a>
                                    ...
                                    <div class="dropdown-divider hidden"></div>
                                    <a class="dropdown-item hidden"
                                       href="<?= base_url() . 'invoices/proforma?no=1&id=' . $invoice['iid']; ?>"><?php echo $this->lang->line('Proforma Invoice'). " No Sign" ?></a>
                ...
                <div id="invoice-company-details" class="row mt-2">
                    ...
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-right">
                        ...
                        <p class="pb-1"> <?php echo $this->config->item('prefix') . ' ' . str_pad($invoice['tid'], 8, '0', STR_PAD_LEFT) . '</p>
...
<th scope="row">' . $c . '</th>
                            ...
                            <td>' . amountExchange($row['subtotal'], 0, $this->aauth->get_user()->loc) . '</td>
                                    ...
                                    if ($row['product_des']||$row['product_unique_id']) {
                                        echo '<tr><td></td><td colspan=8>' . ($row['product_unique_id']? 'Key: '.$row['product_unique_id'].'<br>':'').nl2br($row['product_des']) . '</td></tr>';
                                    }
                                    $c++;
                                } ?>
...
<th scope="row">' . $c . '</th>
                            ...
                            <td>' . amountExchange($row['subtotal'], 0, $this->aauth->get_user()->loc) . '</td>
                                        ...
                                        if ($row['product_des']||$row['product_unique_id']) {
                                            echo '<tr><td></td><td colspan=7>' . ($row['product_unique_id']? 'Key: '.$row['product_unique_id'].'<br>':'').nl2br($row['product_des']) . '</td></tr>';
                                        }
                                        $c++;
                                    } ?>
                            ...
                            <td>' . amountExchange($row['subtotal'], 0, $this->aauth->get_user()->loc) . '</td>
                                        ...
                                        if ($row['product_des']||$row['product_unique_id']) {
                                            echo '<tr><td></td><td colspan=6>' . ($row['product_unique_id']? 'Key: '.$row['product_unique_id'].'<br>':'').nl2br($row['product_des']) . '</td></tr>';
                                        }
                                        $c++;
                                    } ?>
                    ...
                    <div class="row">
                        <div class="col mb-1"><label
                            ...
                            <input type="text" class="form-control"
                                   ...
                                   value="Payment for invoice #<?php echo str_pad($invoice['tid'], 8, '0', STR_PAD_LEFT) ?>"></div>
                    </div>
