            ...
            <div class="card-body">
                <form method="post" id="data_form" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-3">
                            <label class="col-form-label"
                                   for="product_tax"><?php echo $this->lang->line('Default TAX Rate') ?></label>
                            <div class="input-group">
                        ...
                        <div class="col-sm-3">
                            <label class="col-form-label" for="fproduct_price"><?php echo $this->lang->line('Default Discount Rate') ?></label>
                            <div class="input-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="input-group">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="chk_stock_item" name="chk_stock_item" value="1" <?php echo $product['i_stock']==1?"checked":"" ?>>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <select name="unit" class="form-control">
                                <?php
                                echo "<option value='" . $product['unit'] . "'>" . $this->lang->line('Non-Change') . "</option><option value=''>None</option>";
