                            ...
                            <div id="customerpanel" class="inner-cmp-pnl">
                                ...
                                <div id="customer">
                                    ...
                                    <div id="customer_pass"></div>
                                            <?php echo $this->lang->line('Warehouse')." : <strong>".$warehouse_name."</strong>" ?>
                                    <input id="s_warehouses" name="s_warehouses" type="hidden"
                                           class="selectpicker form-control " value="<?php echo $invoice['warehouse_id']?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 cmp-pnl">
                            <div class="inner-cmp-pnl">
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <h3 class="title">
                                            <?php echo $this->lang->line('Invoice Properties') ?>
                                            <span class="red">&nbsp;&nbsp;(<?php echo $this->lang->line('Edit Invoice') ?>)</span>
                                        </h3>
                                    </div>
                        ...
                        <table class="table-responsive tfr my_stripe">
                            <thead>
                                <tr class="item_header bg-gradient-directional-blue white">
                                    ...
                                    <th width="20%" class="text-center"><?php echo $this->lang->line('Unique ID') ?></th>
                                    <th width="2%" ></th>
                                    <th width="8%" class="text-center"><?php echo $this->lang->line('Quantity') ?></th>
                                    <th width="9%" class="text-center"><?php echo $this->lang->line('Rate') ?></th>
                                    <th width="9%" class="text-center"><?php echo $this->lang->line('Tax(%)') ?></th>
                                    <th width="9%" class="text-center"><?php echo $this->lang->line('Tax') ?></th>
                                    <th width="9%" class="text-center"><?php echo $this->lang->line('Discount') ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <input type="text" class="form-control" name="product_name[]"  value="<?php echo $row['product']?>" readonly>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="product_unique_id[]"
                                               placeholder="<?php echo $this->lang->line('Unique ID') ?>"
                                               id='productunique_id_sale-<?php echo $i ?>' value="<?php echo $row['product_unique_id'] ?>"
                                               data-role="sale_unique_key" data-key="saleuniquekey" autocomplete="off" readonly>
                                    </td>
                                    <td>
                                        <i id="product_check-0" class='icon-check text-success'></i>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control req amnt" name="product_qty[]" id="amount-<?php echo $i ?>"
                                               ...
                                               autocomplete="off" value="<?php echo number_format($row['qty'])//amountFormat_general($row['qty'])?>"  data-key="saleqty">
                                        <input type="hidden" name="old_product_qty[]" value="<?php echo number_format($row['qty'])//amountFormat_general($row['qty'])?>" >
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" class="form-control discount" name="product_discount[]"
                                               ...
                                               onkeyup="rowTotal(<?php echo $i ?>), billUpyog()" autocomplete="off"  value="<?php amountFormat_general($row['discount'])?>">
                                    </td>
                                    <td>
                            ...
                            <input type="hidden" class="qtyIn" name="qtyIn[]" id="qtyIn-<?php echo $i ?>" value="<?php echo number_format($row['stock_qty'])?>">
                            <input type="hidden" class="qtyOld" name="qtyOld[]" id="qtyOld-<?php echo $i ?>" value="<?php echo number_format($row['qty'])?>">
                            <input type="hidden" class="pdsIn" name="psid[]" id="psid-<?php echo $i ?>" value="<?php echo $row['stock_id']?>">
                            <input type="hidden" class="istock" name="istock[]" id="istock-<?php echo $i ?>" value="<?php echo $row['i_stock']?>">
                            </tr>
                            <tr class="desc_p">
                                <td colspan="10">
                                    <textarea id="dpid-<?php echo $i ?>" class="form-control" name="product_description[]" placeholder="<?php echo $this->lang->line('Enter Product description') ?>" autocomplete="off"><?php echo ($row['product_des'])?></textarea><br>
                                </td>
                            </tr>
                            <?php
                                $i++;
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                <td colspan="8" class="reverse_align"><input type="hidden"
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                <td colspan="8" class="reverse_align">
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                <td colspan="4"><?php if ($exchange['active'] == 1){
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                <td colspan="4"><?php echo $this->lang->line('Payment Terms') ?> <select
                                        name="pterms"
