...
class Sms Extends CI_Controller
{
    ...
    public function send_telegram(){
        $text_message = $this->input->post('text_message');
        $this->telegram($text_message);
    }
    
    private function telegram($msg) {
        $telegrambot='1017030799:AAFT0FmU80qYI12mTxm1CMUymMzZ7WFcqDo';
        $telegramchatid='-396405534';
        ...
        if($result){
            ...
            echo json_encode(array('status' => 'Error', 'message' => 'Sending Service Error'));
        }
    }
