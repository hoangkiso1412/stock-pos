                            ...
                            <div id="customerpanel" class="inner-cmp-pnl">
                                ...
                                <div id="customer">
                                    ...
                                    <div id="customer_pass"></div><?php echo $this->lang->line('Warehouse') ?> <select
                                            id="s_warehouses" name="s_warehouses" data-key="salewarehouse"
                                            class="form-control">
                        ...
                        <table class="table-responsive tfr my_stripe">
                            ...
                            <tr>
                                <td><input type="text" class="form-control" name="product_name[]"
                                           ...
                                           id='productname_sale-0'>
                                </td>
                                <td><input type="text" class="form-control" name="product_unique_id[]"
                                        placeholder="<?php echo $this->lang->line('Unique ID') ?>"
                                        id='productunique_id_sale-0' data-role="sale_unique_key" data-key="saleuniquekey" autocomplete="off">
                                </td>
                                <td>
                                ...
                                <td><input type="text" class="form-control req amnt" name="product_qty[]" id="amount-0"
                                           ...
                                           autocomplete="off" value="1" data-key="saleqty"><input type="hidden" id="alert-0" value=""
                                                                               name="alert[]"></td>
                                ...
                                <input type="hidden" class="qtyIn" name="qtyIn[]" id="qtyIn-0" value="0">
                                <input type="hidden" class="qtyOld" name="qtyOld[]" id="qtyOld-0" value="0">
                                <input type="hidden" class="pdsIn" name="psid[]" id="psid-0" value="0">
                                <input type="hidden" class="istock" name="istock[]" id="istock-0" value="0">
                            </tr>
                            <tr>
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                <td colspan="8" class="reverse_align"><input type="hidden" value="0" id="subttlform"
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                <td colspan="4"><?php echo $this->lang->line('Payment Terms') ?> <select name="pterms"
