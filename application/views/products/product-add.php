            ...
            <div class="card-body">
                <form method="post" id="data_form">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6"><label class="col-form-label" for="product_name"><?php echo $this->lang->line('Product Name') ?>
                                *</label>
                            <input type="text" placeholder="Product Name" class="form-control margin-bottom required" name="product_name">
                        </div>
                        <div class="col-sm-6"><label class="col-form-label" for="product_code"><?php echo $this->lang->line('Product Code') ?></label>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <select name="product_cat" id="product_cat" class="form-control required select-box">
                            <?php
                            foreach ($cat as $row) {
                                $cid = $row['id'];
                                $title = $row['title'];
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <label class="col-form-label" for="fproduct_price"><?php echo $this->lang->line('Purchase Order') . $this->lang->line('Price') ?></label>
                            <div class="input-group">
                                <span class="input-group-addon"><?php echo $this->config->item('currency') ?></span>
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="input-group">
                                <input type="text" name="product_disc" class="form-control"
                                       ...
                                       aria-describedby="sizing-addon1"
                                       onkeypress="return isNumber(event)"><span class="input-group-addon">%</span>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <label class="col-form-label" for="product_qty_alert"><?php echo $this->lang->line('Stock Item') ?></label>
                            <div class="input-group">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="chk_stock_item" name="chk_stock_item" value="1" checked>
                                    <label class="custom-control-label" for="chk_stock_item"><?php echo $this->lang->line('Check/Uncheck') ?></label>
                                    <br><small>Checked if you want to control stock quantity of this product.</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
