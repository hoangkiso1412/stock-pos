            ...
            <div id="invoice-template" class="card-body">
                        ...
                        if ($invoice['status'] != 'canceled') { ?>
                            ...
                            <a href="#part_payment" data-toggle="modal" data-remote="false" data-type="reminder"
                               class="btn btn-large btn-success" title="Partial Payment">
                                <span class="fa fa-money"></span> <?php echo $this->lang->line('Make Payment') ?>
                            </a>
                            ...
                            <a href="#pop_model_false" data-toggle="modal" data-remote="false"
                               class="btn btn-large btn-success hidden" title="Change Status"
                ...
                <div id="invoice-company-details" class="row mt-2">
                    ...
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-right">
                        ...
                        <p class="pb-1"> <?php echo prefix(2) . str_pad($invoice['tid'], 8, '0', STR_PAD_LEFT) . '</p>
...
<th scope="row">' . $c . '</th>
                            ...
                            <td>' . amountExchange($row['subtotal'], 0, $this->aauth->get_user()->loc) . '</td>
                                    ...
                                    $c++;
                                    if($row['product_unique_id']!=''&&($row['sale_status']!='in-stock'||$row['init_stock']!=$row['warehouse_id']||$row['stock_qty']<=0)){
                                        $btn_remove++;
                                    }
                                } ?>
                    ...
                    <div class="row">
                        <div class="col mb-1"><label
                            ...
                            <input type="text" class="form-control"
                                   ...
                                   value="Payment for purchase #<?php echo str_pad($invoice['tid'], 8, '0', STR_PAD_LEFT) ?>"></div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(e){
        ...
        function check_cancel(){
            var btn_cancel = "<?php echo (int)$btn_remove ?>";
            if(parseInt(btn_cancel)>0){
